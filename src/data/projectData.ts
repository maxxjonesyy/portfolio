...
import { Unsubby, ShiftworkBuddy, Spotify, Taskhub } from "../assets/index";
...
const Projects: Project[] = [
  {
    ...
    website: "https://taskhub-mj.netlify.app/",
    github: "https://github.com/maxxjonesyy/taskhub",
    technology: [
      ["HTML"],
      ["Tailwind"],
      ["Typescript"],
  ...
  },
  {
    ...
    image: Unsubby,
    description:
      "Unsubby groups together unsubscribe links for Gmail, making it easy for you to identify and remove pesky subscriptions with just a few clicks.",
    challenges:
      "Gaining a solid comprehension of the Gmail API and configuring Supabase took some initial reading to kick-start my understanding. Another significant challenge was getting permission for the sensitive scopes I am using, I chose to not pursue this and have Unsubby as an invite only project.",
...

  {
    ...
    image: Spotify,
    description:
      "Spotify dashboard created using their free API. Showcasing user information such as playlists, top artists and recently played songs. As you would expect it also has search functionality.",
    challenges:
